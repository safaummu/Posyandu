...
<html lang="id">
<head>
    <title>Daftar Akun Posyandu</title>
    <style>
        ...
        button { width: 100%; padding: 10px; background: #28a745; color: white; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; }
